...
@Component({
  selector: 'app-scanner-interface-visible',
  templateUrl: './scanner-interface-visible.component.html',
})

export class ScannerInterfaceVisibleComponent implements OnInit {
